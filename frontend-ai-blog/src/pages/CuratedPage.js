      ...
      <div>
        ...
        <div className="relative bg-cyber-black py-16 overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-10" 
              style={{
                backgroundImage: 'radial-gradient(#FFC107 1px, transparent 2px), radial-gradient(#FFC107 1px, transparent 2px)',
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-2xl">
              <h1 className="text-5xl font-cyber font-bold mb-4">
                ...
                <span style={{ color: '#FFC107', textShadow: '0 0 5px rgba(255, 193, 7, 0.7), 0 0 10px rgba(255, 193, 7, 0.5)' }}>Canon</span>
              </h1>
              
              {/* Gold divider for visual balance */}
              <div className="flex mb-6">
                <div className="w-28 h-1 relative" style={{ backgroundColor: '#FFC107' }}>
                  <div className="absolute top-0 left-0 w-full h-full opacity-70"
                      style={{ boxShadow: '0 0 10px 2px #FFC107' }}>
                  </div>
                </div>
                <div className="w-12 h-1 relative" style={{ backgroundColor: '#FFD54F' }}>
                  <div className="absolute top-0 left-0 w-full h-full opacity-70"
                      style={{ boxShadow: '0 0 10px 2px #FFC107' }}>
                  </div>
                </div>
              ...
              <h2 className="text-xl font-cyber mb-6">
                <span style={{ color: '#FFC107', textShadow: '0 0 5px rgba(255, 193, 7, 0.7), 0 0 10px rgba(255, 193, 7, 0.5)' }}>
                  The algorithms that changed everything
                </span>
              </h2>
              
              <p className="text-gray-300 text-lg mb-8 font-body">
                This collection features the groundbreaking papers that fundamentally altered AI's trajectory - 
                the mathematical and algorithmic innovations upon which modern systems are built.
              </p>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="mb-12">
            <h2 className="text-2xl font-cyber font-bold mb-2">Landmark Papers</h2>
            ...
            <div className="flex">
              ...
              <div className="w-20 h-1 relative" style={{ backgroundColor: '#FFC107' }}>
                <div className="absolute top-0 left-0 w-full h-full opacity-70"
                    style={{ boxShadow: '0 0 10px 2px #FFC107' }}>
                </div>
              </div>
