...
from ai_content_engine.agents.writer_agent import generate_blog_post
import asyncio
...
with open(
    f"ai_content_engine/content/posts/blog_post_{paper_id}.txt", "w", encoding="utf-8"
) as f:
    f.write(blog_post)

with open(
    f"ai_content_engine/content/posts/blog_post_{paper_id}.md", "w", encoding="utf-8"
) as f:
    f.write(blog_post)
